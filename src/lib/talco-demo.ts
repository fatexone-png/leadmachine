...
export const TALCO_DEMO_DATA: AppData = {
  ...
  settings: {
    ...
    sourceContext: [
      ...
      "Expertises prioritaires : prévention des risques, industrie & innovation (Règlement Machines, cybersécurité industrielle), entreprises en difficulté, contrats d'affaires complexes.",
      "Clients : dirigeants de PME, ETI industrielles, startups technologiques.",
      "Positionnement : expertise sectorielle, accompagnement stratégique, proximité.",
      "Accroche : Chaque défi mérite un talent à votre mesure.",
